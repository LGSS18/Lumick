    ...
    <form action="" method="POST" name="">
        ...
        <?php
            ...
            if(isset($_POST['buscar']) && !empty($_POST['textobusca'])){
                ...
                $sqlstring = "Select * from filmes where Genero='$pbusca'";
            }
            else{
                $sqlstring = "Select * from filmes order by Genero";
            }
            ...
            while($dados = mysqli_fetch_array($query)){
                ...
                echo "<td align='center'><b>". $dados['Preco']."</b></td>";

                $id = base64_encode($dados['Id']);

                echo "</td> <td align='center'>
                <a href='apagar_filmes.php?id=".$id."'>
                <img src='imagens/iconLixo.png' width='30px' height='30px'></a>";

                echo "</td> <td align='center'>
                <a href='alterar_filmes.php?id=".$id."'>
